...
<body>
        ...
        ***********************************-->
        <div class="nav-header">
            ...
            <a href="/" class="brand-logo">
                <div class="col-md-12">
                    <h6>APP ATLET PPLP</h6>
                </div>
            </a>
            <?php elseif ($userinfo['level'] == 'atlet') : ?>
            <a href="/home_atlet" class="brand-logo">
                <div class="col-md-12">
                    <h6>APP ATLET PPLP</h6>
                </div>
            </a>
            <?php elseif ($userinfo['level'] == 'pelatih') : ?>
            <a href="/home_pelatih" class="brand-logo">
                <div class="col-md-12">
                    <h6>APP ATLET PPLP</h6>
                </div>
            </a>
    ...
    ***********************************-->
    ...
    <script src="<?= base_url() ?>/assets/custom/indikator.js"></script>
    <script src="<?= base_url() ?>/assets/custom/indikator_fisik.js"></script>
    <script src="<?= base_url() ?>/assets/custom/performance_teknik.js"></script>
    <script>
