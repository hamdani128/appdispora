...
<div class="row">
    <div class="col-xl-12 col-xxl-12">
        <div class="row">
            ...
            <?php foreach ($list_cabor as $row) : ?>
            <div class="col-sm-4">
                <div class="card avtivity-card">
                    <div class="card-body" onclick="show_performance_cabor('<?= $row->nama_cabang; ?>')">
                        <div class="media align-items-center">
                            <span class="activity-icon bgl-primary  mr-md-4 mr-3">
                                <svg width="40" height="37" viewBox="0 0 40 37" fill="#FF0010FF"
                            ...
                            <div class="media-body">
                                <p class="fs-14 mb-2">Cabang Olahraga</p>
                                <span class="title text-black font-w600"><?= $row->nama_cabang; ?></span>
                            </div>
                        </div>
                        <div class="progress" style="height:5px;">
                            <div class="progress-bar bg-primary" style="width: 82%; height:5px;" role="progressbar">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="my-modal-title">Informasi Performansi</h5>
