...
<div class="page-titles">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">Penilaian Fisik</a></li>
    </ol>
</div>
                ...
                <div class="card plan-list">
                    <div class="card-header d-sm-flex flex-wrap d-block pb-0 border-0">
                        <div class="mr-auto pr-3 mb-3">
                            <h4 class="text-black fs-20">Form Tes Fisik</h4>
                            <p class="fs-13 mb-0 text-black">Informasi dan Inputan Data Tes Fisik Atlet</p>
                        </div>
                        <div class="card-action card-tabs mr-4 mt-3 mt-sm-0 mb-3">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" data-toggle="tab" href="#All" role="tab"
                                        aria-selected="true">Priview</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " data-toggle="tab" href="#Unifinshed" role="tab"
                                        aria-selected="false">Inputan</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="tab-pane  fade" id="Unifinshed">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="no_nia" placeholder="No.Induk Atlet"
                                            readonly>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="indikator_fisik" id="indikator_fisik" class="form-control"
                                                onchange="ChangeIndikatorFisik()">
                                                <option value="">Pilih Indikator</option>
                                                <?php if(count($indikator) > 0){ ?>
                                                <?php foreach($indikator as $row): ?>
                                                <option value="<?=$row->benchmark?>"><?=$row->komponen_fisik?></option>
                                                <?php endforeach;  ?>
                                                <?php }else{ ?>
                                                <?php } ?>
                                            </select>
                                            <input type="text" class="form-control" name="benchmark" id="benchmark"
                                                readonly placeholder="Nilai Benchmark">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-form-label">Penginputan Penilaian</label>
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="nilai_inputan"
                                                id="nilai_inputan" placeholder="Inputan Nilai">
                                            <input type="text" class="form-control" name="metode_pengukuran"
                                                id="metode_pengukuran" placeholder="Metode Pengukuran">
                                            <input type="text" class="form-control" name="keterangan" id="keterangan"
                                                placeholder="Keterangan">
                                            <div class="input-group-prepend">
                                                <button class="btn btn-primary" type="button"
                                                    onclick="tambah_baris_fisik()">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="table-responsive">
                                        <table class="table table-hover table-bordered" id="table-fisik">
                                            <thead class="bg-info">
                                                <tr class="text-white">
                                                    <th>#Act</th>
                                                    <th>Indikator</th>
                            ...
                            <div class="row pt-3">
                                <div class="col-12 col-lg-12 col-md-12">
                                    <button class="btn btn-md btn-info" onclick="simpan_tes_fisik()">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#" class="btn btn-sm btn-danger"
                                                            onclick="delete_fisik('<?=$row->id?>', '<?=$row->tanggal?>', '<?=$row->atlet_id?>', '<?=$row->nama?>')">
                                    ...
                                    <tr>
                                        <td>
                                            <button type="button" class="btn btn-primary btn-sm"
                                                onclick="pilih_atlet_tes_teknik('<?=$row->no_atlet?>','<?=$row->nama?>','<?=$row->tempat_lahir?>', '<?=$row->tanggal_lahir?>')">
                                                Pilih
                                            </button>
                                        </td>
                                        <td><?=$no++?></td>
