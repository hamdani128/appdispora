                ...
                <div class="profile-info">
                    ...
                    <div class="profile-details">
                        <div class="profile-name px-3 pt-2">
                            ...
                            <p>Pelatih Cabor <?= $profile->departemen; ?></p>
                        </div>
                        <div class="profile-email px-2 pt-2">
                            <h4 class="text-muted mb-0"><?= $profile->level; ?></h4>
                            <p>Status <?= $profile->sub; ?></p>
                        </div>
                        <div class="dropdown ml-auto">
                            <a href="#" class="btn btn-primary light sharp"
                                onclick="update_show_home_pelatih('<?= $profile->username; ?>')">
                            ...
                            <div id="about-me" class="tab-pane fade active show">
                                ...
                                <div class="profile-personal-info">
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-9 col-7"><span><?= $profile->fullname; ?></span>
                                        </div>
                                    </div>
                                    <div class="row mb-2">
                                        <div class="col-sm-3 col-5">
                                        ...
                                        <div class="col-sm-9 col-7"><span><?= $profile->jk; ?></span>
                                        </div>
                                    </div>
